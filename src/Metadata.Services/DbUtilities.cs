...
namespace OneCSharp.Metadata.Services
{
    public static class DbUtilities
    {
        ...
        public static bool IsAutoGeneratedValue(IField field)
        {
            return (field.TypeName == "timestamp" || field.TypeName == "rowversion");
        }
        public static object GetDefaultValueAsObject(IField field)
        {
            if (field.IsNullable)
            {
                return null;
        ...
        public static string GetDefaultValueAsString(IField field)
        {
            if (field.IsNullable)
            {
                return null;
        ...
        public static string GetValueAsString(IField field, object value)
        {
        ...
        public static object GetValueFromString(IField field, string value)
        {
