...
namespace OneCSharp.Integrator.Services
{
    public static class DynamicClassCreator
    {
        private static readonly Regex PropertNameRegex =
                new Regex(@"^[А-Яа-яA-Za-z]+[А-Яа-яA-Za-z0-9_]*$", RegexOptions.Singleline);
        ...
        private static Type GetTypeByTypeSignature(string typeSigniture)
        {
            Type type;
        ...
        private static string GetTypeSignature(IDictionary firstDict, IEnumerable<IDictionary> list)
        {
