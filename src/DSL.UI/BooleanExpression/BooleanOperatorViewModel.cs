...
namespace OneCSharp.DSL.UI
{
    public sealed class BooleanOperatorViewModel : SyntaxNodeViewModel
    {
        ...
        {
            this.ChangeOperatorTypeCommand = new RelayCommand(this.ChangeOperatorType);
            this.AddComparisonOperatorCommand = new RelayCommand(this.AddComparisonOperator);
            this.AddBooleanOperatorCommand = new RelayCommand(this.AddInnerBooleanOperator);
            this.RemoveOperatorCommand = new RelayCommand(this.RemoveOperator);
        ...
        private void ChangeOperatorType(object operatorType) { Keyword = (string)operatorType; }
        private void AddComparisonOperator(object parameter)
        {
        ...
        private void AddInnerBooleanOperator(object parameter)
        {
            BooleanOperator model = this.Model as BooleanOperator;
            if (model == null) return;
        ...
        private void RemoveOperator(object parameter)
        {
            BooleanOperator model = this.Model as BooleanOperator;
            if (model == null) return;
