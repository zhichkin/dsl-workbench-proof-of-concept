...
namespace OneCSharp.Metadata
{
    ...
    internal delegate void SpecialParser(StreamReader reader, string line, DbObject dbo, MetadataProvider server);
    ...
    internal sealed class MetadataReader
    {
        ...
        public void ReadConfig(MetadataProvider server, string fileName, InfoBase infoBase)
        {
        ...
        private void ParseMetadataObject(Stream stream, MetadataProvider server, string fileName, InfoBase infoBase)
        {
            using (StreamReader reader = new StreamReader(stream, Encoding.UTF8))
            {
                string line = reader.ReadLine();
        ...
        private void ParseInternalIdentifier(string line, DbObject dbo, MetadataProvider server)
        {
            string[] lines = line.Split(',');
            string UUID = (dbo.Token == DBToken.Enum ? lines[1] : lines[3]);
            server.UUIDs.Add(UUID, dbo);
        }
        private void ParseDbObjectNames(string line, string fileName, DbObject dbo, MetadataProvider server)
        {
            string[] lines = line.Split(',');
        ...
        private void ParseReferenceOwner(StreamReader reader, DbObject dbo, MetadataProvider server)
        {
            int count = 0;
            string[] lines;
        ...
        private void ParseDbProperties(StreamReader reader, string line, DbObject dbo, MetadataProvider server)
        {
            string[] lines = line.Split(',');
        ...
        private void ParseDbProperty(StreamReader reader, string line, DbObject dbo, MetadataProvider server)
        {
            string[] lines = line.Split(',');
            string fileName = lines[2].Replace("}", string.Empty);
        ...
        private void ParseDbPropertyTypes(StreamReader reader, DbProperty property, MetadataProvider server)
        {
            string line = reader.ReadLine();
            if (line == null) return;
        ...
        private void ParseNestedObjects(StreamReader reader, string line, DbObject dbo, MetadataProvider server)
        {
            string[] lines = line.Split(',');
        ...
        private void ParseNestedObject(StreamReader reader, string line, DbObject dbo, MetadataProvider server)
        {
            string[] lines = line.Split(',');
            string fileName = lines[2].Replace("}", string.Empty);
            string objectName = lines[3].Replace("\"", string.Empty);
        ...
        private void ParseNestedDbProperties(StreamReader reader, DbObject dbo, MetadataProvider server)
        {
            string line;
            Match match;
            while ((line = reader.ReadLine()) != null)
        ...
        #endregion
        public void MakeSecondPass(InfoBase infoBase, MetadataProvider server)
        {
        ...
        internal void SaveDbObjectToFile(DbObject dbo, MetadataProvider server)
        {
